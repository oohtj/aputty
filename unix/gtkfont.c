			       ...
			       fontsel_add_entry callback, void *callback_ctx)
{
	...
	if (fontnames[i][0] == '-') {
	    ...
	    *p++ = '\0';
        ...
        /*
         * Since g_strncasecmp is deprecated under gcc -Werror=deprecated-declarations flag, change function
         * g_strncasecmp to g_ascii_strncasecmp, g_ascii_strcasecmp to g_ascii_strcasecmp
         *
